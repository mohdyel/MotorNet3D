...
train_transforms = Compose([
    ...
    # stack slices into (D,H,W) then add channel → (1,D,H,W)
    Lambdad(
        keys="image",
...
def make_dataset(tomo_ids, tomo_labels):
    ...
    for tid, lbl in zip(tomo_ids, tomo_labels):
        ...
        slices = sorted([os.path.join(img_dir, f)
...
# !pip install torch monai optuna scikit-learn pandas numpy pillow kaggle opendatasets
